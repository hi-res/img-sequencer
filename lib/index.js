...
Sequencer.Player = (function(_super) {
  ...
  Player.prototype.cssbackgroundsize = Modernizr.backgroundsize;
  ...
  */
  ...
  Player.prototype.noload = function(data, frames) {
  ...
  */
  ...
  Player.prototype.set_size = function(width, height) {
    ...
    return Util.resize($frames, this.data.frame.width, this.data.frame.height, this.width, this.height, this.cssbackgroundsize);
  };
