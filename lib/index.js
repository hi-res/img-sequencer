...
Sequencer.SpritesheetPlayer = (function(_super) {
  ...
  */
  ...
  SpritesheetPlayer.prototype._update = function(force) {
    ...
    if (frame !== this.current_frame || force) {
      ...
      this._frames[spritesheet_index].style.backgroundPositionX = background_x + 'px';
      this._frames[spritesheet_index].style.backgroundPositionY = background_y + 'px';
  ...
  */
  ...
  SpritesheetPlayer.prototype.set_size = function(width, height) {
    ...
    $frames = $(this.container).find(this.tag_type);
    return _ref1 = Sequencer.util.resize_spritesheet($frames, this.data.frame.width, this.data.frame.height, this.width, this.height, this.max_frames_horizontal, this.max_frames_vertical), this.frame_width = _ref1[0], this.frame_height = _ref1[1], this.offset_x = _ref1[2], this.offset_y = _ref1[3], _ref1;
  };
