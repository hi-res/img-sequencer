...
Sequencer.SpritesheetPlayer = (function(_super) {
  ...
  */
  ...
  SpritesheetPlayer.prototype._create_frame = function(src) {
    var el;
    el = document.createElement('div');
    el.style.position = 'absolute';
    el.style.width = '100%';
  ...
  */
  ...
  SpritesheetPlayer.prototype._setup = function() {
    ...
    this.max_frames_horizontal = Math.floor(this.data.width / this.data.frame.width);
    this.max_frames_vertical = Math.floor(this.data.height / this.data.frame.height);
    this._frames = [];
    _ref1 = this._cache;
  ...
  SpritesheetPlayer.prototype._update = function() {
    ...
    background_x = -(xpos * this.frame_width) + 'px';
    background_y = -(ypos * this.frame_height) + 'px';
    if (frame !== this.current_frame) {
      this.hide_hd_frame();
      ...
      this._frames[spritesheet_index].style.backgroundPositionX = background_x;
      this._frames[spritesheet_index].style.backgroundPositionY = background_y;
  ...
  */
  ...
  SpritesheetPlayer.prototype.set_size = function(width, height) {
    ...
    this.container.style.height = this.el.style.height;
    $frames = $(this.container).find(this.tag_type);
    return _ref1 = Sequencer.util.resize_spritesheet($frames, this.data.frame.width, this.data.frame.height, this.width, this.height, this.max_frames_horizontal, this.max_frames_vertical), this.frame_width = _ref1[0], this.frame_height = _ref1[1], _ref1;
  };
